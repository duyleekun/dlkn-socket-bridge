...
export type ZaloStateMachineValue = 'idle' | 'qr_connecting' | 'qr_awaiting_scan' | 'qr_scanned' | 'qr_expired' | 'cred_logging_in' | 'logged_in' | 'ws_connecting' | 'listening' | 'reconnecting' | 'error';
...
export type ZaloSessionHostEvent = {
    ...
    type: 'qr_scan_event';
    event: 'scanned' | 'confirmed' | 'declined' | 'expired';
    data?: unknown;
} | {
...
export declare function createSnapshotFromState(value: ZaloStateMachineValue, context: ZaloSerializedState): SessionSnapshot;
